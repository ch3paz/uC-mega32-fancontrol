 ...
 */
#define SD_RAW_WRITE_BUFFERING 0 /* NOTICE:
                                  * 0 --> smaller code, less trouble ;)
                                  */
/**
 * \ingroup sd_raw_config
 ...
 */
#define SD_RAW_SDHC 0 /* NOTICE:
                       * With FAT32 it has to be 1, save mem on 0
                       */
...
#define configure_pin_available() /* NOTICE:
                                   * I've no lockpin. Ignored here.
                                   */
